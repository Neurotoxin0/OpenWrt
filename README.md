...
+ 固件包括但不限于以下程序: 
  ...
  + DNSMASQ(FULL), Docker, Flow Offload KMS Server, OpenClash, OpenVPN Client + Server, Passwall, 
  + QOS, Serverchan, Softenthervpn, SSR Plus, UDP2Raw, UDPSpeeder, uHTTPd, Unblockmusic, UU Game Booster, 
